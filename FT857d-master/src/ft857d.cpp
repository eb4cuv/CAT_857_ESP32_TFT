...
/*
   Modificado por eb4cuv para su uso con ESP32
   Se usa el puerto serie por hardware 2
*/
...
/* por eb4cuv
#define RXD2 16   // Se definen los pines RX y TX
#define TXD2 17
...
void ft857d::begin(long br, int mode) {
     ...
     */
    Serial2.begin(br, mode, RXD2, TXD2);
    Serial2.flush();
}
